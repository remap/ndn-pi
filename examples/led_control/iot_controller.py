...
from pyndn.security.identity import IdentityManager, PublicKey
from pyndn.security.policy import ConfigPolicyManager
from pyndn.security.certificate import IdentityCertificate, CertificateSubjectDescription
from pyndn.encoding import ProtobufTlv

from ndn_pi.iot_identity_storage import IotIdentityStorage
from ndn_pi.iot_policy_manager import IotPolicyManager

from ndn_pi.commands.cert_request_pb2 import CertificateRequestMessage
from ndn_pi.commands.update_capabilities_pb2 import UpdateCapabilitiesCommandMessage
...
if __name__ == '__main__':
    node = IotController('controller.conf')
    node.start()
