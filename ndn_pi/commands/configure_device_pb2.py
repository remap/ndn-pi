...
DESCRIPTOR = descriptor.FileDescriptor(
  ...
  package='',
  serialized_pb='\n\x16\x63onfigure-device.proto\"\x8c\x02\n\x1a\x44\x65viceConfigurationMessage\x12G\n\rconfiguration\x18\xea\x01 \x02(\x0b\x32/.DeviceConfigurationMessage.DeviceConfiguration\x1a\x1a\n\x04Name\x12\x12\n\ncomponents\x18\x08 \x03(\x0c\x1a\x88\x01\n\x13\x44\x65viceConfiguration\x12\x38\n\rnetworkPrefix\x18\xe7\x01 \x02(\x0b\x32 .DeviceConfigurationMessage.Name\x12\x37\n\x0c\x64\x65viceSuffix\x18\xe9\x01 \x02(\x0b\x32 .DeviceConfigurationMessage.Name')
...
_DEVICECONFIGURATIONMESSAGE_DEVICECONFIGURATION = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      number=231, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='deviceSuffix', full_name='DeviceConfigurationMessage.DeviceConfiguration.deviceSuffix', index=1,
      number=233, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
...
_DEVICECONFIGURATIONMESSAGE = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      number=234, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
