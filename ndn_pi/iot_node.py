...
class IotNode(BaseNode):
    ...
    def __init__(self):
        ...
        self.prefix = Name(self.configurePrefix).append(self.deviceSerial)
...
###
    def beforeLoopStart(self):
        ...
        self._hmacHandler = HmacHelper(pin)
        print("Serial: {}\nConfiguration PIN: {}".format(self.deviceSerial, pin.encode('hex')))
